  ...
  return (
    <div className="resume-preview">
      ...
      <section>
        ...
        <p>
          <strong>Mobile Number:</strong> {personalDetails.mobileNumber}
        </p>
        <p>
      ...
      <section>
        ...
        {qualifications.map((qual) => (
          <div key={qual.id}>
            <p>
              <strong>Qualification:</strong> {qual.qualification}
            </p>
            <p>
              <strong>School/College/Institute Name:</strong>{" "}
              {qual.instituteName}
            </p>
            <p>
            ...
            <p>
              <strong>Stream:</strong> {qual.stream}
            </p>
            <p>
              <strong>Start Date:</strong> {qual.startDate}
            </p>
            <p>
              <strong>End Date:</strong> {qual.endDate}
            </p>
            <p>
              <strong>Board/University:</strong> {qual.board}
            </p>
            <p>
              <strong>Marks (Percentage):</strong> {qual.marks}
            </p>
          </div>
        ))}
      </section>
